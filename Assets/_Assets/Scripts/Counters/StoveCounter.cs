...
public class StoveCounter : BaseCounter, IHasProgress
{
    ...
    private FryingRecipeSO GetFryingRecipeSOWithInput(KitchenObjSO inputKitchenObjSO)
    {
        ...
        {
            if (fryingRecipeSO.input == inputKitchenObjSO)
            {
    ...
    private BurningRecipeSO GetBurningRecipeSOWithInput(KitchenObjSO inputKitchenObjSO)
    {
        foreach (BurningRecipeSO burningRecipeSO in burningRecipeSOArray)
        {
            if (burningRecipeSO.input == inputKitchenObjSO)
            {
